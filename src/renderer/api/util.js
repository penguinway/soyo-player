...
// 音乐后缀
export const musicSuffix = ['.mp3', '.wav', '.flac']

// 可播放的后缀
export const suffix = ['.mp4', '.webm', '.ogg', '.mkv', '.avi', '.mov', '.asf', '.wmv', '.navi', '.3gp', '.flv', '.f4v', '.rmvb', '.hddvd', '.rm', '.rmvb', '.mp3', 'wav', 'flac']

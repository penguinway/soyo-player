const message = {
    ...
    common:{
        ...
        // Emotion Analysis related translations
        ...
        analysisError: 'Analysis failed, please make sure the service is running',
        fileTooLarge: 'File too large ({size}MB). For performance reasons, please use videos smaller than 100MB.',
        searchPlaylist: 'Search Files',
        ...
        chat: {
            ...
            useCurrentAudio: 'Use current audio',
            useCurrentVideo: 'Use current video',
            textOnly: 'Text only',
            audioChat: 'Audio chat',
            videoChat: 'Video chat',
            audioTooLarge: 'Audio file too large (>10MB)',
            videoTooLarge: 'Video file too large (>150MB)',
            noMediaSelected: 'No media selected',
            apiKeyRequired: 'API key required',
            apiError: 'Error communicating with AI service',
            clearChat: 'Clear chat',
            configureAPI: 'Configure API',
            audioProcessingError: 'Error processing audio file',
            videoProcessingError: 'Error processing video file',
            audioNotSupported: 'Your browser does not support audio playback',
            supportInfo: 'Supports Qwen series models, can be used for audio/video multimodal chat',
            selectFile: 'Please play a file first, then click audio or video button for multimodal chat',
            processingAudio: 'Processing audio response...',
        },
    },
    user: {
        login: 'Login',

const message = {
    ...
    common:{
        ...
        analysisError: '分析失败，请确保服务已启动',
        showLyrics: '显示歌词',
        showCover: '显示封面',
        fileTooLarge: '视频文件过大 ({size}MB)。为保证性能，请使用小于100MB的视频文件。',
        searchPlaylist: '搜索文件',
        // 对话相关翻译
        chat: {
            title: 'AI对话',
            ...
            send: '发送',
            processing: '处理中...',
            useCurrentAudio: '使用当前音频',
            useCurrentVideo: '使用当前视频',
            textOnly: '仅文字对话',
            audioChat: '音频对话',
            videoChat: '视频对话',
            audioTooLarge: '音频文件过大（>10MB）',
            videoTooLarge: '视频文件过大（>150MB）',
            noMediaSelected: '未选择媒体文件',
            apiKeyRequired: '需要API密钥',
            apiError: '与AI服务通信出错',
            clearChat: '清空对话',
            configureAPI: '配置API',
            audioProcessingError: '处理音频文件出错',
            videoProcessingError: '处理视频文件出错',
            audioNotSupported: '您的浏览器不支持音频播放',
            supportInfo: '支持通义千问系列模型，可用于音频/视频多模态对话',
            selectFile: '请先播放文件，然后点击音频或视频按钮进行多模态对话',
            processingAudio: '正在处理音频响应...'
        },
    },
    user: {
        login: '登录',
